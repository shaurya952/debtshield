...
| 4 | UX, accessibility & Trust Center | 🟡 | Ongoing visual/ease-of-use polish landed (v3 dashboard, unified AppIconBadge). **In-app Trust Center added** (`TrustCenterView`, linked from About): does/never-does, privacy summary, methodology, data sources, accessibility statement, data controls, free help (211/HUD/Benefits), corrections. Shared `DataSecurityCard`. **Still needed:** full screen-by-screen Dynamic Type + VoiceOver audit at accessibility sizes. |
